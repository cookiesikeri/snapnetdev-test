          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu scale-up">
              ...
              <li class="user-header">
                <img src="" class="img-responsive" alt="User Image">
            ...
            <ul class="dropdown-menu scale-up">
              ...
              <li>
                ...
                <ul class="menu inner-content-div">
                  <li><!-- start message -->
                    <a href="{{route('logistic.message.details', $state->id)}}">
                      <div class="pull-left">
                        <img src="https://edekee-backend-main.s3.us-east-2.amazonaws.com/admin/img/user.png" class="img-circle" alt="User Image">
                      </div>
              ...
              <li class="footer"><a href="{{route('logistic.messages')}}">See all messages</a></li>
            </ul>
          </li> --}}
          <!-- Notifications -->
